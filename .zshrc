...
plugins=(git colored-man-pages command-not-found sudo zsh-autosuggestions zsh-syntax-highlighting)
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon root_indicator ram ssh context dir vcs)
